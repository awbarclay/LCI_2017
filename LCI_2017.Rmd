...
An addtional issue with some of the old baseline data is that there are scores for allele 2 of C3N3 in some pops. Look like this is may fault as I filled in genotypes for some collections in areas where we know C3N3 is fixed, but I accidentally added scores to the second allele in some pops.  
